...
public class ExportedRule
{
    ...
    private String dbdFrom;
    private String dbdTo;
    ...
    public void setCreatitonDate(String creationDate)
    {
    ...
    public String getJourneyNumbers()
    {
        return journeyNumbers;
    }

    public void setJourneyNumbers(String journeyNumbers)
    {
